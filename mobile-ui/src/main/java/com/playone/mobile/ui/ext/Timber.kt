...
inline fun d(vararg messages: Any) = log { Timber.v(joinToString(messages)) }
...
inline fun i(vararg messages: Any) = log { Timber.v(joinToString(messages)) }
...
inline fun w(vararg messages: Any) = log { Timber.v(joinToString(messages)) }
...
inline fun e(vararg messages: Any) = log { Timber.v(joinToString(messages)) }
...
inline fun wtf(vararg messages: Any) = log { Timber.v(joinToString(messages)) }
